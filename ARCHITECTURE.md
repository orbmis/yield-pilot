...
2. Server routes use wallet address input to request balances and protocol positions from DeBank.
...
- `lib/portfolio/` normalizes DeBank data.
...
- DeBank for wallet portfolio data.
